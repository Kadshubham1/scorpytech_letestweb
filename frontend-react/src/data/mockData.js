export const mockData = {
  stats: [
    { id: 1, label: "Students Trained", value: "5000+", icon: "users" },
    { id: 2, label: "Placement Rate", value: "85%", icon: "check-circle" },
    { id: 3, label: "Corporate Partners", value: "120+", icon: "award" },
    { id: 4, label: "Live Projects", value: "300+", icon: "cpu" }
  ],
  services: [
    { id: 1, title: "Full Stack Web Dev", description: "Master React, Node.js, and modern databases.", icon: "code", link: "#" },
    { id: 2, title: "AI & Data Science", description: "Learn machine learning pipelines with Python.", icon: "brain", link: "#" },
    { id: 3, title: "Cloud Computing", description: "Deploy scalable systems on AWS and Azure.", icon: "cloud", link: "#" },
    { id: 4, title: "Mobile App Dev", description: "Build cross-platform apps with React Native.", icon: "briefcase", link: "#" },
  ...
  testimonials: [
    { id: 1, text: "The hands-on approach and industry mentors at Scorpy Tech completely transformed my coding abilities. I secured a job at a top tech firm right after graduating.", author_name: "Priya Sharma", author_title: "Software Engineer, TechCorp", author_image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80" },
    { id: 2, text: "Their curriculum is exactly what the industry demands right now. The live projects gave me the confidence to ace technical interviews.", author_name: "Rahul Desai", author_title: "Full Stack Developer", author_image: "https://images.unsplash.com/photo-1599566150163-29194dcaad36?auto=format&fit=crop&w=150&q=80" }
  ],
  faqs: [
    { id: 1, question: "Do you guarantee placements?", answer: "While we do not guarantee placements, we provide 100% placement assistance, including mock interviews and direct referrals to our partner network." },
    { id: 2, question: "Are the instructors industry professionals?", answer: "Yes, all our mentors are currently working in top tech companies like Amazon, Microsoft, and leading startups." },
    { id: 3, question: "Will I get a certificate?", answer: "Yes, you will receive an industry-recognized completion certificate upon finishing your internship projects." }
  ],
  blogs: [
    { id: 1, title: "Why React is Still King in 2026", date: "2026-06-15", read_time: "5 min read", link: "#", image_url: "https://images.unsplash.com/photo-1633356122544-f134324a6cee?auto=format&fit=crop&w=400&q=80" },
    { id: 2, title: "Demystifying Machine Learning for Beginners", date: "2026-06-10", read_time: "7 min read", link: "#", image_url: "https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?auto=format&fit=crop&w=400&q=80" },
    { id: 3, title: "How to Ace Your First Technical Interview", date: "2026-06-05", read_time: "4 min read", link: "#", image_url: "https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=400&q=80" }
  ],
  partners: [
    { id: 1, name: "Pune University", logo_url: "https://images.unsplash.com/photo-1592280771190-3e2e4d571952?auto=format&fit=crop&w=100&q=80" },
